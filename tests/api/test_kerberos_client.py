...
class HttpClientKerberosTests(object):
    ...
    def test_authentication_scheme(self, mocker):
        ...
        mocker.patch('splitio.api.kerberos_client.requests.Session.get', new=get_mock)
        ...
        class post_mock(object):
            ...
            def __exit__(self, exc_type, exc_val, exc_tb):
                pass
        mocker.patch('splitio.api.kerberos_client.requests.Session.post', new=post_mock)
    ...
    def test_telemetry(self, mocker):
        ...
        class post_mock(object):
            ...
            def __exit__(self, exc_type, exc_val, exc_tb):
                pass
        mocker.patch('splitio.api.kerberos_client.requests.Session.post', new=post_mock)
        httpclient = client.HttpClientKerberos(timeout=1500, sdk_url='https://sdk.com', events_url='https://events.com')
