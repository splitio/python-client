...
class HttpClientAsyncTests(object):
    ...
    async def test_get(self, mocker):
        ...
        get_mock = mocker.Mock()
        get_mock.return_value = response_mock
        mocker.patch('splitio.util.load_asyncio.aiohttp.ClientSession.get', new=get_mock)
    ...
    async def test_post(self, mocker):
        ...
        get_mock = mocker.Mock()
        get_mock.return_value = response_mock
        mocker.patch('splitio.util.load_asyncio.aiohttp.ClientSession.post', new=get_mock)
        httpclient = client.HttpClientAsync()
