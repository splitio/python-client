    ...
    def _streaming_feedback_handler(self):
        ...
        while self._push_status_handler_active:
            ...
            if status == Status.PUSH_SUBSYSTEM_UP:
                ...
                self._telemetry_runtime_producer.record_streaming_event((StreamingEventTypes.SYNC_MODE_UPDATE.value, SSESyncMode.STREAMING.value,  get_current_epoch_time()))
                ...
                self._telemetry_runtime_producer.record_streaming_event((StreamingEventTypes.SYNC_MODE_UPDATE.value, SSESyncMode.POLLING.value,  get_current_epoch_time()))
